<?php
/**
 * Bagel Boyz NJ — the ORIGINAL DoorDash / Grubhub order page.
 *
 * Kept verbatim so it can stay live for customers while the new ordering
 * system is in preview.
 *
 * order.php renders this whenever `ordering.public` is false and the visitor
 * has no preview cookie — i.e. for every real customer until you flip the
 * switch. Once ordering goes public this file is no longer reached, but
 * leaving it here means a rollback is one config change, not a git revert.
 */
?>
<!-- Page Header -->
